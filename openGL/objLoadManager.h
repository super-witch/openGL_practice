...
vector<Gameobject> fromOBJloadFace(ObjLoader obj,Color c) {
	...
	for (int i = 0; i < obj.startFaceIndex.size(); i++) {
		...
		for (int i = startIndex; i < endIndex; i++) {
			...
			Face temp = { { {obj.pointSets[Faceindex.first_point_index].x,obj.pointSets[Faceindex.first_point_index].y,obj.pointSets[Faceindex.first_point_index].z,1,obj.pointNormalSets[normalindex.first_point_index]},
							{obj.pointSets[Faceindex.second_point_index].x,obj.pointSets[Faceindex.second_point_index].y,obj.pointSets[Faceindex.second_point_index].z,1,obj.pointNormalSets[normalindex.second_point_index]},
							{obj.pointSets[Faceindex.third_point_index].x,obj.pointSets[Faceindex.third_point_index].y,obj.pointSets[Faceindex.third_point_index].z,1,obj.pointNormalSets[normalindex.third_point_index]}},
							Faceindex.Mat_Name };
			temp.color = c;
